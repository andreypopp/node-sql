...
Table.define = function(config) {
  var table = new this.prototype.constructor(config);
...
Table.prototype.queryClass = Query;
...
Table.prototype.select = function() {
  ...
  var query = new this.queryClass(this);
...
Table.prototype.as = function(alias) {
  ...
  var t = this.constructor.define(this._initialConfig);
  t.alias = alias;
  return t;
};
